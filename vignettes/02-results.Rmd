...
Columns are exaclty the same as in Zonation curves output file, except that 
column names have shortened a little. Note also that the actual feature columns
are named according to feature names in the `Zvariant` object these results 
were deirved from. Thus whatever names you assigned to features prior to 
extracting the results will be also seen here.

Let's see  what the group curves data looks like:
