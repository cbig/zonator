...
As stated above, `zonator` packages provides a particular function 
`create_zproject()` that can be used to create all the necessary files and 
folders for a new Zonation project.  
